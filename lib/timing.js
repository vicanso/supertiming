...
class Timing extends EventEmitter {
   ...
   * @param {Object} extra The extra info for this timing
   ...
   */
    ...
    if (!found.extra) {
      ...
      Object.assign(found.extra, extra);
    }
  ...
  toServerTiming(ignoreChildren) {
    ...
    return arr.map((item, index) => {
      ...
      return `${String.fromCharCode(firstIndex + index)};dur=${use};desc="${desc}"`;
    }).join(',');
  }
  /**
